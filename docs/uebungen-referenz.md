...
20 Büro-Übungen mit Körpergewicht, je ≤ 1 Minute, ohne große Hilfsmittel
(nur Stuhl / Schreibtisch / Wand). Gleichmäßig verteilt über **Mobilisation**,
**Kraft** und **Dehnung**. Jede Übung hat ihren zugeordneten Igel.
...
### 1. Schulterkreisen
<img src="assets/uebungen/01-schulterkreisen.png" width="200">

Schultern langsam nach hinten kreisen, mit dem Atem mitgehen.

### 2. Nacken-/Kopfdrehung (im Sitzen)
<img src="assets/uebungen/02-nacken-kopfdrehung.png" width="200">

Im Sitzen den Kopf langsam zu jeder Seite drehen, Schultern locker.

### 3. Katze-Kuh im Sitzen
<img src="assets/uebungen/03-katze-kuh.png" width="200">

Im Sitzen die Wirbelsäule abwechselnd runden (Katze) und strecken (Kuh).

### 4. Sitz-Drehung
<img src="assets/uebungen/04-sitz-drehung.png" width="200">

Oberkörper zur Seite drehen, eine Hand an der Stuhllehne.

### 5. Handgelenks- & Fingerkreisen
<img src="assets/uebungen/05-handgelenk-finger.png" width="200">

Handgelenke kreisen, dann Finger spreizen — gegen die Maus-Steifheit.

### 6. Armkreisen
<img src="assets/uebungen/06-armkreisen.png" width="200">

Große Kreise mit gestreckten Armen, vorwärts und rückwärts.

### 7. Marschieren / Knie heben
<img src="assets/uebungen/07-marschieren.png" width="200">
...
- [x] 20 Übungen festgelegt & Bilder zugeordnet
- [x] Texte/Sprüche je Übung (siehe [uebungen-texte.md](uebungen-texte.md))
- [ ] **Bizeps**-Sprüche in `uebungen-texte.md` ergänzen (ersetzt Wadenheben)
- [ ] **Bild-Strategie** im Plugin: 20 Bilder als base64-Array einbetten (analog `shared.liquid`)
